...
set COMPILER_OPTIONS=-Od -MTd -nologo -fp:fast -Gm- -GR- -EHsc -Oi -FC -Z7 -WX -W4 -wd4100 -wd4189 -wd4505 -wd4201 -wd4244 -wd4715
set LINKER_OPTIONS=-incremental:no -opt:ref -nologo -SUBSYSTEM:CONSOLE
set FILES=..\stellaris_generator.cpp ..\settingsclass.cpp ..\word.cpp ..\inih-master\cpp\INIReader.cpp ..\inih-master\ini.c
